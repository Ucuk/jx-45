...
{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `*Join Grup JX-45 Community*
https://chat.whatsapp.com/belumada`, 
hasMediaAttachment: true,
...imgsc
}),
nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
...
Tentang tim:
JX-45 berdiri pada tanggal 10 Januari 2025, dibangun oleh Founder Jack & CO-Founder Edward.

Dibangun dengan tujuan mulia, yaitu untuk mempersatukan anak muda dari berbagai latar belakang serta menciptakan komunitas yg solid dan inklusif. Selain itu JX-45 berkomitmen untuk memberikan edukasi kepada masyarakat agar lebih sadar akan bahaya kejahatan dunia maya yg semakin berkembang.
`
...
case "gitclone": {
if (!text) return m.reply(example("https://github.com/Ucuk/ronin"))
...
await fetchJson("https://api.skyzopedia.us.kg/api/ai/openai-prompt?prompt=Sekarang Kamu Adalah JX45-Ai dan selalu gunakan bahasa Indonesia saat menjawab semua pertanyaan&msg=" + talk).then(async (res) => {
...
await m.reply("Kudeta Grup By JX-45 Starting 🔥")
...
if (!isCreator) return Reply(mess.owner)
if (!text) return m.reply(example("jx45|ipserver"))
if (!text.split("|")) return m.reply(example("jx45|ipserver"))
...
const getcase = (cases) => {
const fileContent = fs.readFileSync('./jx45.js').toString();
