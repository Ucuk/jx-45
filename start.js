...
return {
conversation: 'WhatsApp Bot By JX-45'
}}})
...
Don't forget to follow to the JX-45 Community -> https://whatsapp.com/channel/noch `.toString()}`})
console.log(chalk.blue.bold(`JX-45 Botz Connected ✓\n\n`))
randomToken(Sky)
...
profile = 'https://pixhost.to/show/2820/565900276_jx-45-it-private-20250211_113053.jpg';
}
if (action == 'add') {
